...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light">
		...
		<div class="collapse navbar-collapse justify-content-center"
			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item"><a class="nav-link" href="tabella.jsp">Tabella</a>
				</li>
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="formFK">Inserisci Marche/Categorie</a>
	...
	<div class="form-container">
		...
		<form action="Avvio" method="post">
			<input type="hidden" name="scelta" value="1"> <input
				type="text" placeholder="Inserisci un nome prodotto"
				name="nomeProdotto"> <input type="text"
				placeholder="Inserisci un Prezzo" name="prezzoProdotto"><input
				type="date" placeholder="Inserisci data di Produzione"
				name="dataProdotto"> <input type="text"
				placeholder="Inserisci una Quantita' " name="quantitaProdotto">
			...
			<div class="select-wrapper">
				<select name="idMarca">
					...
					<c:forEach var="m" items="${marche}">
						<option value="${m.id}">${m.nomeMarca}</option>
					</c:forEach>
				</select>
			</div>
